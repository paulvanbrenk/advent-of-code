...
const enum Kind { 'todo' = -2, 'error' = -1, 'five', 'four', 'full', 'three', 'two-pair', 'pair', 'high' }
...
function part1(input: string[]) {
    ...
    const valuemap = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];

    const mapped: Hand[] = input.map(c => {
        ...
        switch (bucket.size) {
            ...
            case 4: { kind = Kind.pair; break; }
            case 5: { kind = Kind.high; break; }
            default: { log(bucket.size); throw new Error(); }
        }

        return { cards, value: Number(value), kind };
