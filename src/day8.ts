...
const puzzle_input = `
...
function part1(input: string[]) {
    ...
    const map = new Map(input.slice(2).map((i) => {
    ...
    while (step != 'ZZZ') {
        ...
        if (L == null || R == null) { throw new Error("!!"); }
...
function part2(input: string[]) {
    ...
    const cycles = steps.map(step => {
        ...
        while (!step.endsWith('Z') && !counting) {
            if (!counting && step.endsWith('Z')) { index = 0; }
